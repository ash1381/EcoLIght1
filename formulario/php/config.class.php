...
class Config {
    ...
    public $msg = array('error' => 'Ha ocurrido un error, el mensaje no puede ser enviado!',
                        'success' => 'E-mail enviado con Éxito!<br />Gracias por ponerse en contacto con Ecolight México.'
                    );
